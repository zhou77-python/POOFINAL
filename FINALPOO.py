...
navIcon = PhotoImage(file="icons8-menu-arrondi-30.png")
closeIcon = PhotoImage(file="icons8-menu-arrondi-30.png")
...
# Header label text:
homeLabel = tk.Label(topFrame, text="BFEM", font="Bahnschrift 15", bg=color["orange"], fg="gray17", height=2, padx=20)
homeLabel.pack(side="right")

# Main label text:
brandLabel = tk.Label(root, text="GESTION DES DONNEES ET DELIBEARATION \nBFEM", font="System 30", bg="gray17", fg="green")
...
options = ["GESTION JURY", "ENREGISTREMENTS ", "GESTION DELIBEARATION", "GESTION REPECHAGES", "IMPRESSIONS DES LISTES"]
# Navbar Option Buttons:
#for i in range(5):s
tk.Button(navRoot, text=options[0],command=lambda : jury.gestion_jury(False, True,navRoot) ,font="BahnschriftLight 15", bg="gray17", fg=color["orange"], activebackground="gray17", activeforeground="green", bd=0).place(x=25, y=y)
y += 40
